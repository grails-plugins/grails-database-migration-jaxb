...
class ObjectFactory {
	...
	protected static final QName _Comment_QNAME = new QName('http://www.liquibase.org/xml/ns/dbchangelog', 'comment')
	protected static final QName _DeleteWhere_QNAME = new QName('http://www.liquibase.org/xml/ns/dbchangelog', 'where')
	protected static final QName _LoadDataColumn_QNAME = new QName('http://www.liquibase.org/xml/ns/dbchangelog', 'column')
